        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="assets/img/imagen_login.png"
              alt="Office"
            />
              ...
              <div class="w-full">
                ...
                <label class="block text-sm">
                  ...
                  <input
                    ...
                    placeholder="Codigo Usuario" type="text" name="cod_usr" id="cod_usr"
                  />
                </label>
                ...
                <input type="submit" value="ENTRAR" class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-orange-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-red">

                <hr class="my-8" />

                <p class="mt-4">
                  <a
                    class="text-sm font-medium text-gray-600 dark:text-black-400 hover:underline"
